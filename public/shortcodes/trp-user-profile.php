...
/**
 * Shortcode for displaying user profile.
 *
...
class Trupayers_Customer_Portal_Shortcode_User_Profile {
	...
	public function register() {
        add_shortcode('trp_user_profile', [$this, 'add_shortcode']);
    }
