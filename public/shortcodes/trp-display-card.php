...
class Trupayers_Customer_Portal_Shortcode_Display_Card {
	...
	public function register() {
        add_shortcode('trp_display_card', [$this, 'add_shortcode']);
    }
    ...
    protected function render_template($template_vars) {
        ...
        $this->templates
            ...
            ->get_template_part( 'display', 'card' );
